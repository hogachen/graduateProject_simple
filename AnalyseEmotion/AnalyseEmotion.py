...
def linkword_in_negetive(linkword,n_w):
    if linkword in n_w:
        return -1
    return 0
def analyse_emotion(one_comment_item,p_c_w,n_c_w,p_e_w,n_e_w,g_w_c,n_w,mid_w):
    score = 0;
